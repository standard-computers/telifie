...
CREATE TABLE domains (id VARCHAR(36) PRIMARY KEY, owner VARCHAR(36), name VARCHAR(150), alt VARCHAR(150), permissions INT, origin INT, FOREIGN KEY (owner) REFERENCES users(id))
